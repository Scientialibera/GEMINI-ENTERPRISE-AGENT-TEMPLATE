...
# Changing the MCP endpoint requires redeployment. MCP_SERVER_URL is shared by
# every MCP agent, so a value left over from another one overrides this default.
